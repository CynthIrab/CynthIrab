...
Je m'appelle Cynthia et je suis étudiante en Cybersécurité & Réseaux.
...
🔐 Active Directory
🌐 DNS & DHCP
🖥️ Contrôleur de domaine et serveurs
...
🔐 Cybersécurité — sécurité défensive, reconnaissance, hardening et analyse
🌐 Réseaux — TCP/IP, VLAN, routage, services réseau
🖥️ Administration systèmes — Linux & Windows Server
☁️ Infrastructure — virtualisation, services et environnements cloud
⚙️ Automatisation — Ansible et scripting
🐳 DevOps — Docker, Git et CI/CD
📊 Monitoring & sécurité — supervision, logs et SIEM
